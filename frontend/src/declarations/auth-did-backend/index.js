...
import { idlFactory } from './auth-did-backend.did.js';
export { idlFactory } from './auth-did-backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.REACT_APP_AUTH_DID_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./auth-did-backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the auth-did-backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./auth-did-backend.did.js")._SERVICE>}
 */
export const auth_did_backend = createActor(canisterId);
